...
class Motif(AutotoolsPackage):
    ...
    def setup_build_environment(self, env):
        ...
        # Motif's libXpm sources (XpmCrBufFrI.c, XpmWrFFrI.c) use string.h
        # functions without including the header. Suppress these errors.
        env.append_flags("CFLAGS", "-Wno-implicit-function-declaration -Wno-implicit-int")
        env.append_flags("CXXFLAGS", "-Wno-implicit-function-declaration -Wno-implicit-int")
